...
from ..utils import get_question_by_id, load_subject_data
...
def subject_page(subject_link, question_id=None):
    if subject_link in ["submit", "contact", "images", "static", "api", "question-papers", "questionpapers"]:
        abort(404)
    ...
    question_prefetch_map = [str(question_item.get("question_no")) for question_item in questions]
    ...
    if selected_question:
        ...
        page_title = f"{question_title} | {page_title}"
